...
class ConfigFileTestCase(unittest.TestCase):
    ...
    def test_can_parse_all_values(self):
        ...
        self.assertNull(        cf.get('scope'))
        self.assertEqual(       ['server','user','pw','db'],                cf.enumerate_scope('sql.maria.auth'))
        cf_auth = cf.get('sql.maria.auth')
        self.assertEqual(       ['server','user','pw','db'],                cf_auth.enumerate_scope())
